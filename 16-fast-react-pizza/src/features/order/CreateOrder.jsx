        ...
        <div className="px-4 py-6">
            ...
            <Form method="POST">
                ...
                <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
                    ...
                    {formErrors?.phone &&
                        <p className="mt-2 text-xs text-red-700 bg-red-100 rounder-md p-2">{formErrors.phone}</p>}
                </div>
                ...
                <div className="relative mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
                    ...
                    <div className="grow">
                        ...
                        />
                        {addressStatus === "error" && (
                            <p className="mt-2 text-xs text-red-700 bg-red-100 rounder-md p-2 top-[3px] md:right-[5px] md:top-[5px]">
                                {errorAddress}</p>
                        )}
...
export async function action({request}) {
    ...
    if (!isValidPhone(order.phone))
        errors.phone = "Please add valid phone number";
    ...
    // clear cart when order is completed - do not overuse this technique
